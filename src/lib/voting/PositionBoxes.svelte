<script>
    ...
    export let position;
    let givenCand =  {name: "Julia Kolotev",
        video: "https://drive.google.com/file/d/1S-DRHJqIzDytKcbRrojaYbcMF3APvuNA/preview",
        platform: "hi"
    };
</script>
<Subtitle text = {position} />
<CandidateInfoBox candidate ={{name: "Julia Koltev",
