<script>
    import { user, red_color, green_color, resetUser, sidebar_width_em, updateSize } from "../constants";

    // If user confirms their identity ==> set confirmed to true, show sidebar
